...
<a href="https://github.com/saguileran/birdsongs/">
    <img src="./assets/img/logo.png" alt="birdsongs logo" title="Birdsongs" width="300px" style="padding-bottom:1em !important;" />
</a>

<br>
<br>

![version](https://img.shields.io/badge/package_version-1.1.0-orange)
...
**BirdSongs** i a python package for analyzing, visualizing and generating synthetic birdsongs from recorded audios.
...
- **main:** Python classes and objecst of the model implementation, tutorials, example data (audios), and results.
- **gh-pages:** Documents for the [BirdSongs](https://animalsongs.github.io/birdsongs/) website, a more in-depth description of the package.
...
Import the birdonsg package as `bs` and all its utilities
...
```python
root    = "../examples/"          # root\path\files 
audios  = "../examples/audios/"   # path\to\audios 
results = "../examples/results/"  # path\to\results
catalog = False                   # Import audios with metada 

paths   = bs.Paths(root, audios, results, catalog)
plotter = bs.Plopter(save=True)  # images are saved at ./examples/results/Images/
```

Displays the audios file names found with the `paths.AudioFiles(verbose=True)` function, if the folder has a *spreadsheet.csv* file this function displays all the information about the files inside the folder otherwise it diplays the audio files names found.

#### Birdsong
  
Define and plot the wave sound and spectrogram of the sample *XC11293*. You can use both mp3 and wav files but in Windows you might get errors from `librosa.load`. 
...
<p align="center">  <img src="" width="1000" alt="methodology"></p>
...
- **Birdsongs Descriptions**: characterize and compare birdsongs using the motor gestures 
...
<div class="csl-entry">[1] Amador, A., Perl, Y. S., Mindlin, G. B., &#38; Margoliash, D. (2013). Elemental gesture dynamics are encoded by song premotor cortical neurons. <i>Nature 2013 495:7439</i>, <i>495</i> (7439), 59–64. <a href="https://link.springer.com/book/10.1007/3-540-28249-1">https://link.springer.com/book/10.1007/3-540-28249-1</a>.</div>
<br>

<div class="csl-entry">[2] Mindlin, Gabriel and Laje, Rodrigo. (2005). The Physics of Birdsong. <i>Springer-Verlag Berlin Heidelberg, 2005</i>. <a href="https://doi.org/10.1038/nature11967">https://doi.org/10.1038/nature11967</a>.</div>
<br>

### Software

<div class="csl-entry">[3] Newville, M., Stensitzki, T., Allen, D. B., &#38; Ingargiola, A. (2014). <i>LMFIT: Non-Linear Least-Square Minimization and Curve-Fitting for Python</i>. <a href="https://doi.org/10.5281/ZENODO.11813">https://doi.org/10.5281/ZENODO.11813</a>.</div>
<br>

<div class="csl-entry">[4] McFee, B., Raffel, C., Liang, D., Ellis, D. P., McVicar, M., Battenberg, E., & Nieto, O. &#38; (2015). librosa: Audio and music signal analysis in python. <i>  In Proceedings of the 14th python in science conference </i>, <i>12</i> (12), (Vol. 8). <a href="https://librosa.org/doc/latest/index.html">Librosa</a>. </div><br>

<div class="csl-entry">[5] Ulloa, J. S., Haupert, S., Latorre, J. F., Aubin, T., &#38; Sueur, J. (2021). scikit-maad: An open-source and modular toolbox for quantitative soundscape analysis in Python. <i>Methods in Ecology and Evolution</i>, <i>12</i> (12), 2334–2340. <a href="https://doi.org/10.1111/2041-210X.13711">https://doi.org/10.1111/2041-210X.13711 Dataset</a>.</div>
<br>


### Audios Dataset

<div class="csl-entry">[6] Xeno-canto Foundation and Naturalis Biodiversity Center &#38; (2005). <a href="https://xeno-canto.org/">Xeno-Canto:</a> <i> Sharing bird sounds from around the world.</i> <i>  <a href="https://xeno-canto.org/set/8103">Dissertation Audios Dataset</a>.</i></div>
<br>

<div class="csl-entry">[7] Fink, D., T. Auer, A. Johnston, M. Strimas-Mackey, S. Ligocki, O. Robinson, W. Hochachka, L. Jaromczyk, C. Crowley, K. Dunham, A. Stillman, I. Davies, A. Rodewald, V. Ruiz-Gutierrez, C. Wood. 2023. <i>eBird Status and Trends, Data Version: 2022; Released: 2023</i>. Cornell Lab of Ornithology, Ithaca, New York. <a href="https://doi.org/10.2173/ebirdst.2022">https://doi.org/10.2173/ebirdst.2022</a>. </div>
